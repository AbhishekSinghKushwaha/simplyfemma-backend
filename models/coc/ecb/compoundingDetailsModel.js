...
const ecbcompoundingSchema = new Schema({
    userId: {
        type: String,
        default : uuidv4(),
    },
...
ecbcompoundingSchema.index({userId: 1});

ecbcompoundingdetails = cocConnect.model('ecbcompoundingdetails', ecbcompoundingSchema, 'SF_Compounding_Details_ECB');

module.exports = ecbcompoundingdetails;