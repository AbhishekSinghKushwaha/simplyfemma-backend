...
const ecbentitySchema = new Schema({
    userId: {
        type: String,
        default : uuidv4()
    },
...
ecbentitySchema.index({ userId : 1});

const ecbentitydetails  = cocConnect.model('ecbentitydetails', ecbentitySchema, 'SF_Entity_Details_ECB');

// applicationdetails.collection.createIndex({ applicantCode : 1 }); 
// applicationdetails.syncIndexes();

module.exports = ecbentitydetails;