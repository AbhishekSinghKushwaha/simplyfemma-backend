...
const pocompoundingSchema = new Schema({
    userId: {
        type: String,
        default : uuidv4(),
    },
...
pocompoundingSchema.index({userId: 1});

pocompoundingdetails = cocConnect.model('pocompoundingdetails', pocompoundingSchema, 'SF_Compounding_Details_PO');

module.exports = pocompoundingdetails;