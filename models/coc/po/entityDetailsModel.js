...
const poentitySchema = new Schema({
    userId: {
        type: String,
        default : uuidv4()
    },
...
poentitySchema.index({ userId : 1});

const poentitydetails  = cocConnect.model('poentitydetails', poentitySchema, 'SF_Entity_Details_PO');

// applicationdetails.collection.createIndex({ applicantCode : 1 }); 
// applicationdetails.syncIndexes();

module.exports = poentitydetails;