...
const odientitySchema = new Schema({
    userId: {
        type: String,
        default : uuidv4()
    },
...
odientitySchema.index({ userId : 1});

const odientitydetails  = cocConnect.model('odientitydetails', odientitySchema, 'SF_Entity_Details_ODI');

// applicationdetails.collection.createIndex({ applicantCode : 1 }); 
// applicationdetails.syncIndexes();

module.exports = odientitydetails;