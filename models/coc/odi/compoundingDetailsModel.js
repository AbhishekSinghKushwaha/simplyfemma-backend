...
const odicompoundingSchema = new Schema({
    userId: {
        type: String,
        default : uuidv4(),
    },
...
odicompoundingSchema.index({userId: 1});

odicompoundingdetails = cocConnect.model('odicompoundingdetails', odicompoundingSchema, 'SF_Compounding_Details_ODI');

module.exports = odicompoundingdetails;