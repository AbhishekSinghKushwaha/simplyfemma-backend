...
const fdientitySchema = new Schema({
    userId: {
        type: String,
        default : uuidv4()
    },
...
fdientitySchema.index({ userId : 1});

const fdientitydetails  = cocConnect.model('fdientitydetails', fdientitySchema, 'SF_Entity_Details_FDI');

// applicationdetails.collection.createIndex({ applicantCode : 1 }); 
// applicationdetails.syncIndexes();

module.exports = fdientitydetails;