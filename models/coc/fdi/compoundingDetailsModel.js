...
const fdicompoundingSchema = new Schema({
    userId: {
        type: String,
        default : uuidv4(),
    },
...
fdicompoundingSchema.index({userId: 1});

fdicompoundingdetails = cocConnect.model('fdicompoundingdetails', fdicompoundingSchema, 'SF_Compounding_Details_FDI');

module.exports = fdicompoundingdetails;