...
const locompoundingSchema = new Schema({
    userId: {
        type: String,
        default : uuidv4(),
    },
...
locompoundingSchema.index({userId: 1});

locompoundingdetails = cocConnect.model('locompoundingdetails', locompoundingSchema, 'SF_Compounding_Details_LO');

module.exports = locompoundingdetails;