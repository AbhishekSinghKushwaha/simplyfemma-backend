...
const loentitySchema = new Schema({
    userId: {
        type: String,
        default : uuidv4()
    },
...
loentitySchema.index({ userId : 1});

const loentitydetails  = cocConnect.model('loentitydetails', loentitySchema, 'SF_Entity_Details_LO');

// applicationdetails.collection.createIndex({ applicantCode : 1 }); 
// applicationdetails.syncIndexes();

module.exports = loentitydetails;