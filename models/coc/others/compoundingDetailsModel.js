...
const otherscompoundingSchema = new Schema({
    userId: {
        type: String,
        default : uuidv4(),
    },
...
otherscompoundingSchema.index({userId: 1});

otherscompoundingdetails = cocConnect.model('otherscompoundingdetails', otherscompoundingSchema, 'SF_Compounding_Details_OTHERS');

module.exports = otherscompoundingdetails;