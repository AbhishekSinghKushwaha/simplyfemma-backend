...
const othersentitySchema = new Schema({
    userId: {
        type: String,
        default : uuidv4()
    },
...
othersentitySchema.index({ userId : 1});

const othersentitydetails  = cocConnect.model('othersentitydetails', othersentitySchema, 'SF_Entity_Details_OTHERS');

// applicationdetails.collection.createIndex({ applicantCode : 1 }); 
// applicationdetails.syncIndexes();

module.exports = othersentitydetails;